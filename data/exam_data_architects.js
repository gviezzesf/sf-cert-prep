Object.assign(EXAM_DATA, {
  "Platform Integration Architect":{
    ...
    overview:"The Platform Integration Architect credential is aimed at experienced architects who design and build integrations between Salesforce and external systems. The exam tests your ability to select the right integration pattern for a given scenario, choose appropriate APIs (REST, SOAP, Bulk, Streaming), design secure and resilient solutions using OAuth, Named Credentials, and Shield, and govern integration landscapes at scale. Candidates are expected to have at least five years of Salesforce experience and hands-on knowledge of integration platforms such as MuleSoft.",
        domains:[
      {name:"Evaluate the Current System Landscape",pct:8,color:"#00A1E0",desc:"Given a set of business requirements, identify the current system landscape and determine what standards, limitations...",keyTopics:[{title:"Given a set of business requirements, identify the curren...",desc:"Given a set of business requirements, identify the current system landscape and determine what standards, limitations, boundaries, and protocols exist."},{title:"Given an existing system landscape, analyze for constrain...",desc:"Given an existing system landscape, analyze for constraints and/or pain-points to satisfy a business requirement(s)."},{title:"Given a set of requirements, evaluate the authentication",desc:"Given a set of requirements, evaluate the authentication and authorization needs based on the system landscape."}]},
      {name:"Evaluate Business Needs",pct:11,color:"#2ECC71",desc:"Given a use case, identify functional and non-functional requirements needed for integration.",keyTopics:[{title:"Given a use case, identify functional",desc:"Given a use case, identify functional and non-functional requirements needed for integration."},{title:"Based on a given integration requirement, identify",desc:"Based on a given integration requirement, identify and classify data into Confidential/Secure/Public."},{title:"Given a use case, identify key factors for CRM success th...",desc:"Given a use case, identify key factors for CRM success that should be included as integration requirements."},{title:"Given a use case, identify the business growth",desc:"Given a use case, identify the business growth and regulatory factors that can impact choice of integration solutions."}]},
      {name:"Translate Needs to Integration Requirements",pct:22,color:"#F39C12",desc:"Given an existing system landscape diagram, create an inventory of the systems and integration patterns.",keyTopics:[{title:"Given an existing system landscape diagram, create an inv...",desc:"Given an existing system landscape diagram, create an inventory of the systems and integration patterns."},{title:"Given a use case",desc:"Given a use case and business process, evaluate system and process constraints."},{title:"Given a use case, identify integration security/authentic...",desc:"Given a use case, identify integration security/authentication/authorization requirements."},{title:"Given a use case, identify performance needs",desc:"Given a use case, identify performance needs (volumes, response times, latency) and propose appropriate integration solutions that will meet business requirements."}]},
      {name:"Design Integration Solutions",pct:28,color:"#E74C3C",desc:"Given a use case, identify the integration pattern that meets business requirements.",keyTopics:[{title:"Given a use case, identify the integration pattern that m...",desc:"Given a use case, identify the integration pattern that meets business requirements."},{title:"Given a use case, define the components which create a so...",desc:"Given a use case, define the components which create a solution that meets business requirements."},{title:"Given a use case, identify the trade-offs, limitations,",desc:"Given a use case, identify the trade-offs, limitations, and constraints that meet the proposed solution."},{title:"Given a use case that includes technical requirements, co...",desc:"Given a use case that includes technical requirements, constraints, or drivers, specify the appropriate Salesforce application programming interface(s) (API) for the proposed solution."},{title:"Given a use case that includes technical requirements, co...",desc:"Given a use case that includes technical requirements, constraints, or drivers, determine the standards, components, techniques, and security mechanism that should be used."}]},
      {name:"Build Solution",pct:23,color:"#9B59B6",desc:"Given a use case that includes technical requirements, constraints, or drivers, identify the considerations when desi...",keyTopics:[{title:"Given a use case that includes technical requirements, co...",desc:"Given a use case that includes technical requirements, constraints, or drivers, identify the considerations when designing and implementing an API(s), both Salesforce as an API provider and Salesforce as an API consumer."},{title:"Given a use case, identify the considerations when choosi...",desc:"Given a use case, identify the considerations when choosing the right option in making an outbound call to an external system."},{title:"Given a use case, describe what should be considered when...",desc:"Given a use case, describe what should be considered when building a scalable solution."},{title:"Given a use case, determine error handling for different ...",desc:"Given a use case, determine error handling for different integration options."},{title:"Given a use case, create a security solution for inbound ...",desc:"Given a use case, create a security solution for inbound or outbound integrations."},{title:"Given a use case, identify the factors needed to build re...",desc:"Given a use case, identify the factors needed to build resilience in an integration solution for system updates."}]},
      {name:"Maintain Integration",pct:8,color:"#1ABC9C",desc:"Given an integration maintenance use case, identify performance monitoring needs for integration requirements.",keyTopics:[{title:"Given an integration maintenance use case, identify perfo...",desc:"Given an integration maintenance use case, identify performance monitoring needs for integration requirements."},{title:"Given a use case, identify the appropriate error handling...",desc:"Given a use case, identify the appropriate error handling, escalation, and recovery procedures for a failed integration."},{title:"Given a use case, identify reporting needs for integratio...",desc:"Given a use case, identify reporting needs for integration monitoring."}]},
    ],
    studyDays:[
  ...
  "Platform Data Architect": {
    ...
    overview: "The Salesforce Platform Data Architect certification validates expertise in designing scalable, high-performance data models for complex Salesforce implementations. Candidates demonstrate mastery of data modeling, large data volumes, data governance, and data migration strategies.",
        domains:[
      {name:"Data Modeling/Database Design",pct:25,color:"#00A1E0",desc:"Compare and contrast various techniques and considerations for designing a data model for the Customer 360 Platform. ...",keyTopics:[{title:"Compare",desc:"Compare and contrast various techniques and considerations for designing a data model for the Customer 360 Platform. (for example, objects, fields & relationships, object features)."},{title:"recommend approaches",desc:"Given a scenario, recommend approaches and techniques to design a scalable data model that obeys the current security and sharing model."},{title:"Compare",desc:"Compare and contrast various techniques, approaches and considerations for capturing and managing business and technical metadata (for example, business dictionary, data lineage, taxonomy, data classification)."},{title:"Compare",desc:"Compare and contrast the different reasons for implementing big objects versus standard/custom objects within a production instance, alongside the unique pros and cons of utilizing big objects in a Salesforce data model."},{title:"Given a customer scenario, recommend approaches",desc:"Given a customer scenario, recommend approaches and techniques to avoid data skew (record locking, sharing calculation issues, and excessive child to parent relationships)."}]},
      {name:"Master Data Management",pct:5,color:"#2ECC71",desc:"Compare and contrast the various techniques, approaches and considerations for implementing master data management (M...",keyTopics:[{title:"Compare",desc:"Compare and contrast the various techniques, approaches and considerations for implementing master data management (MDM) Solutions (for example, MDM implementation styles; harmonizing and consolidating data from multiple sources; establishing data survivorship rules, thresholds and weights; leveraging external reference data for enrichment; canonical modeling techniques, hierarchy management)."},{title:"Given a customer scenario, recommend",desc:"Given a customer scenario, recommend and use techniques for establishing a 'golden record' or 'system of truth' for the customer domain in a single org."},{title:"Given a customer scenario, recommend approaches",desc:"Given a customer scenario, recommend approaches and techniques for consolidating data attributes from multiple sources. Discuss criteria and methodology for picking the winning attributes."},{title:"Given a customer scenario, recommend appropriate approaches",desc:"Given a customer scenario, recommend appropriate approaches and techniques to capture and maintain customer reference and metadata to preserve traceability and establish a common context for business rules."}]},
      {name:"Salesforce Data Management",pct:25,color:"#F39C12",desc:"Given a customer scenario, recommend appropriate combination of Salesforce license types to effectively leverage stan...",keyTopics:[{title:"Given a customer scenario, recommend appropriate combinat...",desc:"Given a customer scenario, recommend appropriate combination of Salesforce license types to effectively leverage standard and custom objects to meet business needs."},{title:"Given a customer scenario, recommend techniques to ensure...",desc:"Given a customer scenario, recommend techniques to ensure data is persisted in a consistent manner."},{title:"with multiple systems of interaction, describe techniques...",desc:"Given a scenario with multiple systems of interaction, describe techniques to represent a single view of the customer on the Salesforce Platform."},{title:"Given a customer scenario, recommend a design to effectiv...",desc:"Given a customer scenario, recommend a design to effectively consolidate and/or leverage data from multiple Salesforce instances."}]},
      {name:"Data Governance",pct:10,color:"#E74C3C",desc:"Given a customer scenario, recommend an approach for designing a General Data Protection Regulation (GDPR) compliant ...",keyTopics:[{title:"Given a customer scenario, recommend an approach for desi...",desc:"Given a customer scenario, recommend an approach for designing a General Data Protection Regulation (GDPR) compliant data model. Discuss the various options to identify, classify, and protect personal and sensitive information."},{title:"Compare",desc:"Compare and contrast various approaches and considerations for designing and implementing an enterprise data governance program."}]},
      {name:"Large Data Volume Considerations",pct:20,color:"#9B59B6",desc:"Given a customer scenario, design a data model that scales considering LDV and solution performance.",keyTopics:[{title:"Given a customer scenario, design a data model that scale...",desc:"Given a customer scenario, design a data model that scales considering LDV and solution performance."},{title:"Given a customer scenario, recommend a data archiving",desc:"Given a customer scenario, recommend a data archiving and purging plan that is optimal for the customer's data storage management needs."},{title:"Given a customer scenario, decide when to use virtualized...",desc:"Given a customer scenario, decide when to use virtualized data and describe virtualized data options."}]},
      {name:"Data Migration",pct:15,color:"#1ABC9C",desc:"Given a customer scenario, recommend appropriate techniques and methods for ensuring high data quality at load time.",keyTopics:[{title:"Given a customer scenario, recommend appropriate techniques",desc:"Given a customer scenario, recommend appropriate techniques and methods for ensuring high data quality at load time."},{title:"Compare",desc:"Compare and contrast various techniques for improving performance when migrating LDVs into Salesforce."},{title:"Compare",desc:"Compare and contrast various techniques and considerations for exporting data from Salesforce."}]},
    ],
    studyDays:[
  ...
  "Platform Sharing and Visibility Architect": {
    ...
    overview: "The Platform Sharing and Visibility Architect certification validates expertise in designing comprehensive Salesforce security and data sharing architectures. Candidates demonstrate mastery of org-wide defaults, sharing rules, role hierarchies, permission sets, and team-based access models.",
        domains:[
      {name:"Permissions to Standard Objects, Custom Objects, and Fields",pct:27,color:"#00A1E0",desc:"Apply knowledge to recommend the right level of object permissions needed to provide the appropriate access to a set ...",keyTopics:[{title:"recommend the right level of object permissions needed to...",desc:"Given a scenario, recommend the right level of object permissions needed to provide the appropriate access to a set of users."},{title:"recommend the correct level of field permissions needed t...",desc:"Given a scenario, recommend the correct level of field permissions needed to provide the appropriate access to a set of users."},{title:"recommend the appropriate mechanism to hide data at the u...",desc:"Given a scenario, recommend the appropriate mechanism to hide data at the user interface level."},{title:"determine the appropriate access controls to protect sens...",desc:"Given a scenario, determine the appropriate access controls to protect sensitive data (for example, PCI, PII, or HIPAA)."},{title:"recommend the appropriate programmatic solution to ensure...",desc:"Given a scenario, recommend the appropriate programmatic solution to ensure security settings are enforced."}]},
      {name:"Access to Records",pct:39,color:"#2ECC71",desc:"Given a set of conditions, recommend the appropriate organization-wide defaults to restrict access to records.",keyTopics:[{title:"Given a set of conditions, recommend the appropriate orga...",desc:"Given a set of conditions, recommend the appropriate organization-wide defaults to restrict access to records."},{title:"Given a set of conditions, recommend a solution that leve...",desc:"Given a set of conditions, recommend a solution that leverages the role hierarchy to support the record access requirements."},{title:"Given a set of conditions, determine how sharing rules ca...",desc:"Given a set of conditions, determine how sharing rules can be implemented to support the record access requirements."},{title:"Given a set of conditions, determine how groups can suppo...",desc:"Given a set of conditions, determine how groups can support the record access requirements."},{title:"Given a set of conditions, determine how teams can suppor...",desc:"Given a set of conditions, determine how teams can support the record access requirements."},{title:"Given a set of conditions, determine the correct object r...",desc:"Given a set of conditions, determine the correct object relationships that support record access sharing requirements."},{title:"Given a set of conditions, determine how programmatic sha...",desc:"Given a set of conditions, determine how programmatic sharing supports the record access requirements."},{title:"Given a set of conditions, determine what sharing mechani...",desc:"Given a set of conditions, determine what sharing mechanism is appropriate to share records with External Users."},{title:"Given a set of conditions, determine how record access ov...",desc:"Given a set of conditions, determine how record access overrides support the record access requirements."}]},
      {name:"Access to Other Data",pct:16,color:"#F39C12",desc:"Apply knowledge to determine the appropriate access control needed to grant access to data that is not standard or cu...",keyTopics:[{title:"determine the appropriate access control needed to grant ...",desc:"Given a scenario, determine the appropriate access control needed to grant access to data that is not standard or custom objects."}]},
      {name:"Implications of Security Model Choice",pct:18,color:"#E74C3C",desc:"Apply knowledge to determine the scalability implications of the sharing solution.",keyTopics:[{title:"determine the scalability implications of the sharing sol...",desc:"Given a scenario, determine the scalability implications of the sharing solution."},{title:"Given a set of conditions, determine the license limitati...",desc:"Given a set of conditions, determine the license limitations that will impact the intended sharing solution."},{title:"Given a set of conditions, determine how to test the shar...",desc:"Given a set of conditions, determine how to test the sharing model."}]},
    ],
    studyDays:[
  ...
  "Platform Identity and Access Management Architect": {
    ...
    overview: "The Platform Identity and Access Management Architect certification validates expertise in designing enterprise identity solutions on the Salesforce platform. Candidates demonstrate mastery of SSO, OAuth 2.0, identity providers, connected apps, and MFA.",
        domains:[
      {name:"Identity Management Concepts",pct:17,color:"#00A1E0",desc:"Describe common authentication patterns and understand the differences between each one.",keyTopics:[{title:"Describe common authentication patterns",desc:"Describe common authentication patterns and understand the differences between each one."},{title:"building blocks that are part of an identity solution",desc:"Describe the building blocks that are part of an identity solution (authentication, authorization, and accountability) and how you enable those building blocks using Salesforce features."},{title:"Describe how trust is established between two systems",desc:"Describe how trust is established between two systems."},{title:"recommend the appropriate method for provisioning users i...",desc:"Given a scenario, recommend the appropriate method for provisioning users in Salesforce."},{title:"troubleshoot common points of failure that may be encount...",desc:"Given a scenario, troubleshoot common points of failure that may be encountered in a single sign-on (SSO) solution (SAML, OAuth, etc.)."}]},
      {name:"Accepting Third-Party Identity in Salesforce",pct:21,color:"#2ECC71",desc:"Given a use case, describe when Salesforce is used as a Service Provider (SP).",keyTopics:[{title:"Given a use case, describe when Salesforce is used as a S...",desc:"Given a use case, describe when Salesforce is used as a Service Provider (SP)."},{title:"recommend the most appropriate way to provision users fro...",desc:"Given a scenario, recommend the most appropriate way to provision users from identity stores in business-to-employer (B2E) and business-to-consumer (B2C) scenarios."},{title:"recommend the appropriate authentication mechanism when S...",desc:"Given a scenario, recommend the appropriate authentication mechanism when Salesforce needs to accept third-party Identity (Enterprise Directory, Social, Community, etc.)."},{title:"identify the ways to provision users in Salesforce to ena...",desc:"Given a scenario, identify the ways to provision users in Salesforce to enable SSO and apply access rights."},{title:"identify the auditing",desc:"Given a scenario, identify the auditing and monitoring approaches available on the platform, and describe the tools available to diagnose Identity Provider (IdP) issues."}]},
      {name:"Salesforce as an Identity Provider",pct:17,color:"#F39C12",desc:"Apply knowledge to identify the most appropriate OAuth flow (Web-based, JWT, User agent, Device auth flow).",keyTopics:[{title:"identify the most appropriate OAuth flow",desc:"Given a scenario, identify the most appropriate OAuth flow (Web-based, JWT, User agent, Device auth flow)."},{title:"recommend appropriate Scope",desc:"Given a scenario, recommend appropriate Scope and Configuration of the Connected App for Authorization."},{title:"various implementation concepts of OAuth",desc:"Describe the various implementation concepts of OAuth (scopes, secrets, tokens, refresh tokens, token expiration, token revocation, etc.)."},{title:"recommend the Salesforce technologies that should be used...",desc:"Given a scenario, recommend the Salesforce technologies that should be used to provide identity to the third-party system (Canvas, Connected Apps, App Launcher, etc.)."}]},
      {name:"Access Management Best Practices",pct:15,color:"#E74C3C",desc:"Given a set of requirements, determine the most appropriate methods of multi-factor authentication (MFA) to use, and ...",keyTopics:[{title:"Given a set of requirements, determine the most appropria...",desc:"Given a set of requirements, determine the most appropriate methods of multi-factor authentication (MFA) to use, and the right type of session they should yield."},{title:"determine how to best assign roles, profiles,",desc:"Given a scenario, determine how to best assign roles, profiles, and permission sets to a user during the SSO process, how to keep these assignments up to date."},{title:"describe which tools you can apply to audit",desc:"Given a scenario, describe which tools you can apply to audit and verify the activity/user during and after login."},{title:"identify the configuration settings for a Connected App",desc:"Given a scenario, identify the configuration settings for a Connected App."}]},
      {name:"Salesforce Identity",pct:12,color:"#9B59B6",desc:"Given a set of requirements, identify the role Identity Connect plays in a Salesforce Identity implementation.",keyTopics:[{title:"Given a set of requirements, identify the role Identity C...",desc:"Given a set of requirements, identify the role Identity Connect plays in a Salesforce Identity implementation."},{title:"identify if Salesforce Customer 360 Identity fits into a ...",desc:"Given a scenario, identify if Salesforce Customer 360 Identity fits into a fully-developed Customer 360 solution."},{title:"Give a set of requirements, recommend the most appropriat...",desc:"Give a set of requirements, recommend the most appropriate Salesforce license type(s)."}]},
      {name:"Community (Partner and Customer)",pct:18,color:"#1ABC9C",desc:"Understand the capabilities for customizing the user experience for Experience Cloud (Branding options, authenticatio...",keyTopics:[{title:"capabilities for customizing the user experience for Expe...",desc:"Describe the capabilities for customizing the user experience for Experience Cloud (Branding options, authentication options, identity verification self-registration, communications, password reset, etc.)."},{title:"Given a set of requirements, determine the best way to su...",desc:"Given a set of requirements, determine the best way to support external IdPs in communities and leverage the right user/contact model to support community user experience."},{title:"Given a requirement, understand the advantages",desc:"Given a requirement, understand the advantages and limitations of External Identity solutions and associated licenses."},{title:"determine when to use embedded login",desc:"Given a scenario, determine when to use embedded login."}]},
    ],
    studyDays:[
  ...
  "Platform Development Lifecycle and Deployment Architect": {
    ...
    overview: "The Platform Development Lifecycle and Deployment Architect certification validates expertise in designing and managing Salesforce development lifecycles. Candidates demonstrate mastery of environment strategy, source control, CI/CD pipelines, testing strategies, and metadata deployment.",
        domains:[
      {name:"Application Lifecycle Management",pct:8,color:"#00A1E0",desc:"Given the project risk and customer requirements, explain how to assess the benefits and risks of the different devel...",keyTopics:[{title:"Given the project risk",desc:"Given the project risk and customer requirements, explain how to assess the benefits and risks of the different development methodologies and recommend the appropriate governance strategies based on the customer maturity."}]},
      {name:"Planning",pct:13,color:"#2ECC71",desc:"Given a complex customer scenario, assess application lifecycle management maturity and identify the people, technolo...",keyTopics:[{title:"Given a complex customer scenario, assess application lif...",desc:"Given a complex customer scenario, assess application lifecycle management maturity and identify the people, technology, and processes required."},{title:"Understand customer environment risks",desc:"Understand customer environment risks and articulate appropriate mitigation strategies."},{title:"Given a customer scenario, analyze",desc:"Given a customer scenario, analyze and recommend the appropriate governance framework."},{title:"Given a customer scenario involving a new Salesforce release",desc:"Given a customer scenario involving a new Salesforce release (Summer, Winter, Spring), recommend the appropriate strategy to mitigate risks."}]},
      {name:"System Design",pct:15,color:"#F39C12",desc:"Understand the advantages of using agile tools to support an agile development process.",keyTopics:[{title:"advantages of using agile tools to support an agile devel...",desc:"Explain the advantages of using agile tools to support an agile development process."},{title:"Given a customer landscape",desc:"Given a customer landscape and their requirements, evaluate business, technical, and architectural considerations that support the defined org strategy."},{title:"Given a customer scenario, define an environment",desc:"Given a customer scenario, define an environment (sandbox) strategy that utilizes the correct sandbox types (for example, multiple project streams, training requirements, staging, production, and hotfixes)."},{title:"compare, contrast,",desc:"Given a scenario, compare, contrast, and recommend the components and tools of a successful deployment strategy."}]},
      {name:"Building",pct:14,color:"#E74C3C",desc:"Given a customer scenario, explain how to use source control branching/versioning/merging, and recommend appropriate ...",keyTopics:[{title:"Given a customer scenario, explain how to use source cont...",desc:"Given a customer scenario, explain how to use source control branching/versioning/merging, and recommend appropriate strategies."},{title:"appropriate approaches to building test data strategy",desc:"Describe the appropriate approaches to building test data strategy and unit test to ensure successful code (positive, negative, permission-based, large data volume)."},{title:"Given a customer scenario, describe the appropriate devel...",desc:"Given a customer scenario, describe the appropriate development model (org-based vs package-based) and development environment (scratch org vs sandboxes)."},{title:"methods to ensure the delivery of quality code",desc:"Describe the methods to ensure the delivery of quality code, such as coding standards, pull requests, code review, and static code analysis."}]},
      {name:"Deploying",pct:14,color:"#9B59B6",desc:"Apply knowledge to describe the capabilities, limitations, and considerations when using the Metadata and Tooling API...",keyTopics:[{title:"describe the capabilities, limitations,",desc:"Given a scenario, describe the capabilities, limitations, and considerations when using the Metadata and Tooling APIs for deployment."},{title:"describe approaches to handle pre",desc:"Given a scenario, describe approaches to handle pre and post-deployment steps, including items not supported via the APIs."},{title:"describe approaches to manage",desc:"Given a scenario, describe approaches to manage and deploy technical reference data."}]},
      {name:"Testing",pct:13,color:"#1ABC9C",desc:"Given a customer scenario, describe and recommend an appropriate testing methodology.",keyTopics:[{title:"Given a customer scenario, describe",desc:"Given a customer scenario, describe and recommend an appropriate testing methodology."},{title:"Given a customer testing strategy, describe the appropria...",desc:"Given a customer testing strategy, describe the appropriate test execution methodology and coverage requirements."},{title:"Given a customer scenario, describe",desc:"Given a customer scenario, describe and recommend a unified test data strategy that utilizes representative data in a secure manner throughout the development lifecycle."}]},
      {name:"Releasing",pct:13,color:"#E67E22",desc:"Apply knowledge to analyze and explain the use cases and considerations when using managed, unmanaged, and unlocked p...",keyTopics:[{title:"analyze",desc:"Given a scenario, analyze and explain the use cases and considerations when using managed, unmanaged, and unlocked packages."},{title:"map sandbox strategy to a specific release plan, taking i...",desc:"Apply map sandbox strategy to a specific release plan, taking into consideration multiple project streams, training requirements, staging, and hotfixes."},{title:"Given a customer scenario, describe",desc:"Given a customer scenario, describe and recommend an appropriate release management strategy."}]},
      {name:"Operating",pct:10,color:"#3498DB",desc:"Given a detailed customer environment scenario including a specific request, explain the implications of incorporatin...",keyTopics:[{title:"Given a detailed customer environment scenario including ...",desc:"Given a detailed customer environment scenario including a specific request, explain the implications of incorporating the request directly in a production environment."},{title:"Given a customer scenario where changes are made directly...",desc:"Given a customer scenario where changes are made directly in production, explain the implications on the development lifecycle and steps to integrate changes into application lifecycle management."},{title:"Given a multi-org customer scenario, compare",desc:"Given a multi-org customer scenario, compare and contrast approaches for managing common release artifacts."}]},
    ],
    studyDays:[
  ...
  "B2C Solution Architect": {
    ...
    overview: "The Salesforce B2C Solution Architect certification validates expertise in designing end-to-end solutions for B2C companies. Candidates demonstrate the ability to architect multi-cloud solutions spanning B2C Commerce, Marketing Cloud, Service Cloud, and Loyalty Management.",
        domains:[
      {name:"Discovery and Customer Success",pct:27,color:"#00A1E0",desc:"Apply knowledge to determine how to facilitate a successful customer engagement (agenda, plan, gather requirements, d...",keyTopics:[{title:"determine how to facilitate a successful customer engagement",desc:"Given a scenario, determine how to facilitate a successful customer engagement (agenda, plan, gather requirements, document, and design)."},{title:"Given a set of business requirements",desc:"Given a set of business requirements and the understanding of standard Salesforce product capabilities, explain the reasoning and considerations to use a certain product."},{title:"with a B2C architecture, validate that the associated sys...",desc:"Given a scenario with a B2C architecture, validate that the associated systems of record, key objects, and risks have been captured and explained."},{title:"Given a set of requirements, recommend the implementation...",desc:"Given a set of requirements, recommend the implementation approach and associated relative effort."},{title:"articulate dev-ops lifecycle",desc:"Given a scenario, articulate dev-ops lifecycle and governance required in a multi-cloud environment to achieve change management goals."}]},
      {name:"Functional Capabilities and Business Value",pct:7,color:"#2ECC71",desc:"Given a set of customer requirements, recommend suitable B2C products and solution approach to demonstrate a customer...",keyTopics:[{title:"Given a set of customer requirements, recommend suitable ...",desc:"Given a set of customer requirements, recommend suitable B2C products and solution approach to demonstrate a customer process which includes marketing, purchase, service and loyalty."},{title:"Given a set of customer requirements for post-purchase ac...",desc:"Given a set of customer requirements for post-purchase activities in a multi-cloud solution, demonstrate how the customer experience can be achieved by leveraging Salesforce B2C products."}]},
      {name:"Architecture Design",pct:18,color:"#F39C12",desc:"Given the understanding of retail solution architecture and integrations, illustrate how Salesforce products interact...",keyTopics:[{title:"Given the understanding of retail solution architecture",desc:"Given the understanding of retail solution architecture and integrations, illustrate how Salesforce products interact with each other and third-party systems to support consumer commerce journeys."},{title:"Given a use case, analyze business processes",desc:"Given a use case, analyze business processes and propose a customer experience solution that generates business value that meets expectations."},{title:"Given a use case, recommend a multi-cloud strategy",desc:"Given a use case, recommend a multi-cloud strategy and implementation approach to create custom personalized experiences that utilize the power of the Customer Data Platform."},{title:"Given data security",desc:"Given data security and residency requirements, recommend an appropriate solution and describe how the solution's considerations can impact implementation."}]},
      {name:"Data Models and Management",pct:25,color:"#E74C3C",desc:"Given the Salesforce supported standard object definitions for Commerce objects (profile, orders, products), articula...",keyTopics:[{title:"Given the Salesforce supported standard object definition...",desc:"Given the Salesforce supported standard object definitions for Commerce objects (profile, orders, products), articulate how key business entities relate between systems of record and systems of engagement."},{title:"Given a set of business objectives",desc:"Given a set of business objectives and priorities, recommend an appropriate sequence for system integration, data exchanges, and process updates to satisfy known requirements, with recommendations and potential impact to overall program delivery."},{title:"Given a set of customer requirements, articulate the priv...",desc:"Given a set of customer requirements, articulate the privacy management features across multiple clouds, when to consider a custom solution vs. using out-of-the-box (OOTB) features."},{title:"identify appropriate systems of record",desc:"Given a scenario, identify appropriate systems of record and describe how you would extend the standard data model for high volume processing, articulate system limitations, and recommend preferred methods for integration between various data formats."},{title:"that requires knowledge of common data migration strategies",desc:"Given a scenario that requires knowledge of common data migration strategies and standard Salesforce data migration tools, demonstrate best practices on how to transfer data between products and development environments."}]},
      {name:"Integration",pct:23,color:"#9B59B6",desc:"Given a set of customer requirements, recommend an appropriate design and approach for a multi-cloud integration, und...",keyTopics:[{title:"Given a set of customer requirements, recommend an approp...",desc:"Given a set of customer requirements, recommend an appropriate design and approach for a multi-cloud integration, understanding the OOTB features, system limitations, and when custom integration is required."},{title:"Given business requirements",desc:"Given business requirements and use cases, recommend appropriate integration patterns based on data volume, latency, and system limitations."},{title:"Given a B2C use case, recommend features",desc:"Given a B2C use case, recommend features and approaches that ensure security for both customers and internal business users while complying with regional and local legal requirements."},{title:"recommended methods on how to integrate systems to Servic...",desc:"Understand the recommended methods on how to integrate systems to Service Cloud, B2C Commerce, and Marketing Cloud environments using APIs and protocols that support various integration design patterns."}]},
    ],
    studyDays:[
  ...
  "Heroku Architect": {
    ...
    overview: "The Heroku Architect certification validates expertise in designing and architecting cloud applications on the Heroku platform, including Salesforce integration patterns. Candidates demonstrate mastery of Heroku architecture, deployment, scaling, security, and integration with Salesforce.",
        domains:[
      {name:"Heroku Platform",pct:10,color:"#00A1E0",desc:"Demonstrate an understanding of the basics behind building and deploying apps on Heroku.",keyTopics:[{title:"Demonstrate an understanding of the basics behind building",desc:"Demonstrate an understanding of the basics behind building and deploying apps on Heroku."},{title:"Architect scalable solutions that are performant even dur...",desc:"Architect scalable solutions that are performant even during high-traffic spikes."},{title:"Architect",desc:"Architect and deploy solutions using add-ons and other components from the Elements Marketplace, including various add-ons, buildpacks, and Heroku Buttons."}]},
      {name:"Security",pct:15,color:"#2ECC71",desc:"Construct architectures that leverage Heroku to achieve different security certifications.",keyTopics:[{title:"Construct architectures that leverage Heroku to achieve d...",desc:"Construct architectures that leverage Heroku to achieve different security certifications."},{title:"Recommend Heroku Private Space Peering or VPN connections...",desc:"Recommend Heroku Private Space Peering or VPN connections for appropriate use cases."},{title:"Recommend when an app should run in the Private Space Run...",desc:"Recommend when an app should run in the Private Space Runtime versus the Common Runtime."}]},
      {name:"Heroku Enterprise",pct:28,color:"#F39C12",desc:"Demonstrate how features of Heroku Enterprise can improve a system's architecture.",keyTopics:[{title:"Demonstrate how features of Heroku Enterprise can improve...",desc:"Demonstrate how features of Heroku Enterprise can improve a system's architecture."},{title:"Recommend networking solutions that use Heroku Private Sp...",desc:"Recommend networking solutions that use Heroku Private Spaces or the Common Runtime, appropriately."},{title:"compliance features of Heroku Shield",desc:"Describe the compliance features of Heroku Shield."},{title:"features of Enterprise Teams",desc:"Describe the features of Enterprise Teams."}]},
      {name:"Architect Applications",pct:15,color:"#E74C3C",desc:"Recommend architectures that use the Twelve-Factor App methodology correctly.",keyTopics:[{title:"Recommend architectures that use the Twelve-Factor App me...",desc:"Recommend architectures that use the Twelve-Factor App methodology correctly."},{title:"Construct solutions for creating an orchestration layer f...",desc:"Construct solutions for creating an orchestration layer for building a microservices architecture using Apache Kafka on Heroku."}]},
      {name:"Integrations",pct:15,color:"#9B59B6",desc:"Recommend architectures that use Heroku Connect appropriately, including the correct use of External IDs.",keyTopics:[{title:"Recommend architectures that use Heroku Connect appropria...",desc:"Recommend architectures that use Heroku Connect appropriately, including the correct use of External IDs."},{title:"Recommend techniques to integrate Heroku apps with the Sa...",desc:"Recommend techniques to integrate Heroku apps with the Salesforce Lightning Platform, and understand when to apply particular techniques."}]},
    ],
    studyDays:[
  ...
  "Tableau Architect": {
    ...
    overview: "The Tableau Architect certification validates expertise in designing and architecting enterprise Tableau deployments. Candidates demonstrate the ability to design scalable analytics environments, data governance frameworks, performance-optimized workbooks, and integration with Salesforce Einstein Analytics.",
        domains:[
      {name:"Design a Tableau Infrastructure",pct:22,color:"#00A1E0",desc:"1.1 Gather requirements for implementing a complex Tableau deployment",keyTopics:[{title:"1.1 Gather requirements for implementing a complex Tablea...",desc:"1.1 Gather requirements for implementing a complex Tableau deployment"},{title:"1.1.1 Evaluate requirements for users",desc:"1.1.1 Evaluate requirements for users and their role distributions"},{title:"1.1.2 Identify relevant constraints",desc:"1.1.2 Identify relevant constraints and requirements, including future growth"},{title:"1.1.3 Identify requirements for",desc:"1.1.3 Identify requirements for and recommend a strategy for licensing, including Authorization-to-Run (ATR)"},{title:"1.1.4 Assess the need for high availability",desc:"1.1.4 Assess the need for high availability and disaster recovery"},{title:"1.1.5 Map the features",desc:"1.1.5 Map the features and capabilities of the Tableau Server Add-Ons to requirements"},{title:"1.2 Plan",desc:"1.2 Plan and implement Tableau Cloud"},{title:"1.2.1 Plan",desc:"1.2.1 Plan and implement Tableau Bridge"},{title:"1.2.2 Plan",desc:"1.2.2 Plan and implement authentication"},{title:"1.2.3 Plan",desc:"1.2.3 Plan and implement automated user provisioning, including System for Cross-Domain Identity Management (SCIM)"},{title:"1.2.4 Troubleshoot advanced configuration issues",desc:"1.2.4 Troubleshoot advanced configuration issues"},{title:"1.2.5 Plan",desc:"1.2.5 Plan and implement multi-sites using Tableau Cloud Manager"},{title:"1.3 Plan a migration",desc:"1.3 Plan a migration"},{title:"1.3.1 Plan a migration of Tableau Cloud to Tableau Server",desc:"1.3.1 Plan a migration of Tableau Cloud to Tableau Server"},{title:"1.3.2 Plan a migration of Tableau Server to Tableau Cloud",desc:"1.3.2 Plan a migration of Tableau Server to Tableau Cloud"},{title:"1.3.3 Plan a migration from Windows to Linux",desc:"1.3.3 Plan a migration from Windows to Linux"},{title:"1.3.4 Plan a migration from Linux to Windows",desc:"1.3.4 Plan a migration from Linux to Windows"},{title:"1.3.5 Plan a migration from one identity store to another",desc:"1.3.5 Plan a migration from one identity store to another"},{title:"1.3.6 Plan a consolidation of multiple Tableau servers or...",desc:"1.3.6 Plan a consolidation of multiple Tableau servers or sites into fewer servers or sites"},{title:"1.3.7 Plan a migration from one Tableau Server environmen...",desc:"1.3.7 Plan a migration from one Tableau Server environment to another"},{title:"1.3.8 Create scripts for migration",desc:"1.3.8 Create scripts for migration"},{title:"1.3.9 Use the Tableau Content Migration Tool",desc:"1.3.9 Use the Tableau Content Migration Tool"},{title:"1.4 Design an appropriate process topology",desc:"1.4 Design an appropriate process topology"},{title:"1.4.1 Specify process counts",desc:"1.4.1 Specify process counts (sizing)"},{title:"1.4.2 Specify node count",desc:"1.4.2 Specify node count"},{title:"1.4.3 Specify service-to-node relationships",desc:"1.4.3 Specify service-to-node relationships (node roles), including service isolation and service colocation"},{title:"1.4.4 Specify when to use external services",desc:"1.4.4 Specify when to use external services"},{title:"1.5 Recommend a Tableau Server configuration",desc:"1.5 Recommend a Tableau Server configuration"},{title:"1.5.1 Recommend an appropriate identity store",desc:"1.5.1 Recommend an appropriate identity store and authentication configuration"},{title:"1.5.2 Recommend specific configuration keys",desc:"1.5.2 Recommend specific configuration keys and values to suit a given use case"},{title:"1.5.3 Recommend a configuration to address security requi...",desc:"1.5.3 Recommend a configuration to address security requirements such as encryption at rest and encryption over the wire"},{title:"1.5.4 Recommend hardware",desc:"1.5.4 Recommend hardware and network specifications"},{title:"1.5.5 Create a disaster recovery strategy",desc:"1.5.5 Create a disaster recovery strategy"}]},
      {name:"Deploy Tableau Server",pct:37,color:"#2ECC71",desc:"2.1 Implement production-ready Tableau Server deployments",keyTopics:[{title:"2.1 Implement production-ready Tableau Server deployments",desc:"2.1 Implement production-ready Tableau Server deployments"},{title:"2.1.1 Deploy",desc:"2.1.1 Deploy and configure Tableau Server"},{title:"2.1.1.1 Configure an external file store",desc:"2.1.1.1 Configure an external file store"},{title:"2.1.1.2 Configure an external repository",desc:"2.1.1.2 Configure an external repository"},{title:"2.1.1.3 Configure an external gateway",desc:"2.1.1.3 Configure an external gateway"},{title:"2.1.1.4 Configure an unlicensed node",desc:"2.1.1.4 Configure an unlicensed node"},{title:"2.1.1.5 Configure a coordination ensemble",desc:"2.1.1.5 Configure a coordination ensemble"},{title:"2.1.1.6 Configure a backgrounder process with a specific ...",desc:"2.1.1.6 Configure a backgrounder process with a specific node role"},{title:"2.1.1.7 Configure Tableau for a load balancer",desc:"2.1.1.7 Configure Tableau for a load balancer"},{title:"2.1.2 Install in an air-gapped environment",desc:"2.1.2 Install in an air-gapped environment"},{title:"2.1.3 Validate a disaster recovery/high availability test...",desc:"2.1.3 Validate a disaster recovery/high availability test strategy"},{title:"2.1.4 Perform a blue-green deployment",desc:"2.1.4 Perform a blue-green deployment"},{title:"2.1.5 Locate",desc:"2.1.5 Locate and interpret Tableau Server installation logs"},{title:"2.1.6 Install",desc:"2.1.6 Install and configure Resource Monitoring Tool server and agents"},{title:"2.1.7 Plan",desc:"2.1.7 Plan and implement automated deployment (using a script, that is, Silent Installer)"},{title:"2.2 Configure",desc:"2.2 Configure and troubleshoot supported authentication methods"},{title:"2.2.1 Configure",desc:"2.2.1 Configure and troubleshoot SAML"},{title:"2.2.2 Configure",desc:"2.2.2 Configure and troubleshoot Kerberos"},{title:"2.2.3 Configure",desc:"2.2.3 Configure and troubleshoot OpenID Connect"},{title:"2.2.4 Configure",desc:"2.2.4 Configure and troubleshoot Mutual SSL"},{title:"2.2.5 Configure",desc:"2.2.5 Configure and troubleshoot trusted authentication"},{title:"2.2.6 Configure",desc:"2.2.6 Configure and troubleshoot Connected App authentication"},{title:"2.2.7 Configure",desc:"2.2.7 Configure and troubleshoot LDAP"},{title:"2.2.8 Configure",desc:"2.2.8 Configure and troubleshoot Azure Active Directory"},{title:"2.2.9 Identify dependencies between authentication methods",desc:"2.2.9 Identify dependencies between authentication methods and Tableau environments, including Tableau Cloud"},{title:"2.3 Implement encryption",desc:"2.3 Implement encryption"},{title:"2.3.1 Implement SSL encryption",desc:"2.3.1 Implement SSL encryption"},{title:"2.3.2 Implement database encryption",desc:"2.3.2 Implement database encryption"},{title:"2.3.3 Implement extract encryption",desc:"2.3.3 Implement extract encryption"},{title:"2.3.4 Set up service principal names",desc:"2.3.4 Set up service principal names (SPNs) for Kerberos"},{title:"2.4 Install",desc:"2.4 Install and verify Tableau Server on Linux"},{title:"2.4.1 Install Tableau Server on Linux by using CLI or the...",desc:"2.4.1 Install Tableau Server on Linux by using CLI or the Installation Wizard"},{title:"2.4.2 Identify",desc:"2.4.2 Identify and resolve issues with installation on Linux"},{title:"2.4.3 Identify",desc:"2.4.3 Identify and resolve issues with operating system and networking configurations"},{title:"2.4.4 Identify",desc:"2.4.4 Identify and resolve issues with interfaces and interactions with external systems"},{title:"2.4.5 Identify",desc:"2.4.5 Identify and resolve issues with proxy issues"},{title:"2.4.6 Identify appropriate operating system logs",desc:"2.4.6 Identify appropriate operating system logs and Tableau logs for troubleshooting"},{title:"2.4.7 Verify system groups",desc:"2.4.7 Verify system groups and file system permissions"},{title:"2.5 Install",desc:"2.5 Install and verify Tableau Server on Windows"},{title:"2.5.1 Install Tableau Server on Windows by using CLI or t...",desc:"2.5.1 Install Tableau Server on Windows by using CLI or the Installation Wizard"},{title:"2.5.2 Identify",desc:"2.5.2 Identify and resolve issues with installation on Windows"},{title:"2.5.3 Identify",desc:"2.5.3 Identify and resolve issues with operating system and networking configurations"},{title:"2.5.4 Identify",desc:"2.5.4 Identify and resolve issues with interfaces and interactions with external systems"},{title:"2.5.5 Identify",desc:"2.5.5 Identify and resolve proxy issues"},{title:"2.5.6 Identify appropriate operating system logs",desc:"2.5.6 Identify appropriate operating system logs and Tableau logs for troubleshooting"},{title:"2.5.7 Verify system groups",desc:"2.5.7 Verify system groups and file system permissions"},{title:"2.5.8 Use the Run As service account",desc:"2.5.8 Use the Run As service account"}]},
      {name:"Monitor and Maintain a Tableau Deployment",pct:41,color:"#F39C12",desc:"3.1 Create custom administrative views",keyTopics:[{title:"3.1 Create custom administrative views",desc:"3.1 Create custom administrative views"},{title:"3.1.1 Interpret the repository schema",desc:"3.1.1 Interpret the repository schema and the event types"},{title:"3.1.2 Build admin dashboards for common scenarios",desc:"3.1.2 Build admin dashboards for common scenarios"},{title:"3.1.3 Utilize Admin Insights on Tableau Cloud",desc:"3.1.3 Utilize Admin Insights on Tableau Cloud"},{title:"3.2 Perform load testing",desc:"3.2 Perform load testing"},{title:"3.2.1 Recommend a load testing strategy",desc:"3.2.1 Recommend a load testing strategy"},{title:"3.2.2 Configure",desc:"3.2.2 Configure and use a load testing tool such as TabJolt"},{title:"3.2.3 Configure a test environment",desc:"3.2.3 Configure a test environment"},{title:"3.2.4 Create appropriate test plans",desc:"3.2.4 Create appropriate test plans"},{title:"3.2.5 Interpret load test results",desc:"3.2.5 Interpret load test results and determine the appropriate action"},{title:"3.3 Identify",desc:"3.3 Identify and resolve performance bottlenecks"},{title:"3.3.1 Troubleshoot complex performance issues related to ...",desc:"3.3.1 Troubleshoot complex performance issues related to workbooks, data sources, and other types of content"},{title:"3.3.2 Perform resource analysis, latency analysis,",desc:"3.3.2 Perform resource analysis, latency analysis, and workload analysis to determine root cause of performance issues"},{title:"3.3.3 Create an action to resolve issues identified in pe...",desc:"3.3.3 Create an action to resolve issues identified in performance recordings"},{title:"3.3.4 Optimize caching for Tableau Server",desc:"3.3.4 Optimize caching for Tableau Server"},{title:"3.4 Maintain",desc:"3.4 Maintain and tune a Tableau Server environment by using observability data"},{title:"3.4.1 Map the features",desc:"3.4.1 Map the features and capabilities of the Tableau Server Resource Monitoring Tool to observability requirements"},{title:"3.4.2 Recommend a strategy for collecting",desc:"3.4.2 Recommend a strategy for collecting and analyzing Tableau Server logs"},{title:"3.4.3 Recommend a strategy for collecting",desc:"3.4.3 Recommend a strategy for collecting and analyzing Tableau Server process metrics"},{title:"3.4.4 Recommend a strategy for collecting",desc:"3.4.4 Recommend a strategy for collecting and analyzing operating system and hardware-related metrics"},{title:"3.4.5 Interpret observability data",desc:"3.4.5 Interpret observability data"},{title:"3.4.6 Revise architecture based on observability data",desc:"3.4.6 Revise architecture based on observability data"},{title:"3.4.7 Troubleshoot connectivity in a single or multi-node...",desc:"3.4.7 Troubleshoot connectivity in a single or multi-node environment, especially database connectivity"},{title:"3.4.8 Configure",desc:"3.4.8 Configure and implement Activity Log for Tableau Cloud or Tableau Server"},{title:"3.5 Automate server maintenance functions",desc:"3.5 Automate server maintenance functions"},{title:"3.5.1 Manage",desc:"3.5.1 Manage and change Tableau Server resources programmatically, including Tableau Services Manager (TSM), REST APIs, and tabcmd"},{title:"3.5.2 Recommend a script deployment method",desc:"3.5.2 Recommend a script deployment method, including Windows Scheduler and cron"},{title:"3.5.3 Recommend automated deployment methods for Tableau ...",desc:"3.5.3 Recommend automated deployment methods for Tableau Server, Tableau Desktop, and Tableau Prep"},{title:"3.5.4 Design an automated complex disaster recovery process",desc:"3.5.4 Design an automated complex disaster recovery process"},{title:"3.5.5 Plan",desc:"3.5.5 Plan and implement multi-node server upgrades"},{title:"3.5.6 Automate maintenance tasks",desc:"3.5.6 Automate maintenance tasks, such as cleanup and backup"},{title:"3.5.7 Configure",desc:"3.5.7 Configure and use the Metadata API"},{title:"3.6 Manage server extensions",desc:"3.6 Manage server extensions"},{title:"3.6.1 Schedule content automation tasks by using webhooks...",desc:"3.6.1 Schedule content automation tasks by using webhooks, tabcmd, REST, or Hyper APIs"},{title:"3.6.2 Implement",desc:"3.6.2 Implement and configure dashboard extensions and web data connectors"},{title:"3.6.3 Configure trusted tickets",desc:"3.6.3 Configure trusted tickets and connected apps for a custom embedded solution"}]},
    ],
    studyDays:[
  ...
  "MuleSoft Platform Architect": {
    ...
    overview: "The MuleSoft Certified Platform Architect - Level 1 certification validates the ability to design enterprise integration architectures using MuleSoft Anypoint Platform. Candidates demonstrate mastery of API-led connectivity, system design, governance, and enterprise deployment strategies.",
        domains:[
      {name:"Explaining application network basics",pct:7,color:"#00A1E0",desc:"Identify and differentiate between technologies typically used to implement API-led connectivity.",keyTopics:[{title:"Identify",desc:"Identify and differentiate between technologies typically used to implement API-led connectivity."},{title:"role",desc:"Describe the role and characteristics of web APIs."},{title:"Correctly assign APIs to tiers according to ownership, fu...",desc:"Correctly assign APIs to tiers according to ownership, functional focus, and rate of change."},{title:"capabilities",desc:"Describe the capabilities and high-level components of Anypoint Platform."}]},
      {name:"Establishing organizational and platform foundations",pct:10,color:"#2ECC71",desc:"Advise on establishing a Center for Enablement (C4E) and identify key performance indicators (KPIs) to measure its su...",keyTopics:[{title:"Advise on establishing a Center for Enablement",desc:"Advise on establishing a Center for Enablement (C4E) and identify key performance indicators (KPIs) to measure its success."},{title:"high-level structure",desc:"Describe the high-level structure and benefits of MuleSoft Catalyst."},{title:"Choose between options for hosting",desc:"Choose between options for hosting and managing Anypoint Platform control and runtime planes."},{title:"Compare",desc:"Compare and contrast Identity Management and Client Management options on Anypoint Platform."},{title:"Identify data residency of different kinds of data",desc:"Identify data residency of different kinds of data (payload, metrics, and others)."}]},
      {name:"Designing and sharing APIs",pct:10,color:"#F39C12",desc:"Identify dependencies between an API, its API specification, its implementation, and its clients.",keyTopics:[{title:"Identify dependencies between an API, its API specificati...",desc:"Identify dependencies between an API, its API specification, its implementation, and its clients."},{title:"creation",desc:"Describe the creation and publication of reusable API-related assets using API specifications and Anypoint Platform components."},{title:"Identify changes to an API that would require or not requ...",desc:"Identify changes to an API that would require or not require changing the major/minor/patch component of its semantic version."},{title:"Given a specific power relationship between two Bounded C...",desc:"Given a specific power relationship between two Bounded Contexts, choose the most appropriate strategy for mapping between the API data models of these Bounded Contexts."},{title:"Identify idempotent HTTP methods",desc:"Identify idempotent HTTP methods and HTTP-native support for optimistic concurrency."}]},
      {name:"Designing APIs using System, Process, and Experience Layers",pct:12,color:"#E74C3C",desc:"Identify appropriate APIs to implement a business process and assign them to layers of API-led connectivity.",keyTopics:[{title:"Identify appropriate APIs to implement a business process",desc:"Identify appropriate APIs to implement a business process and assign them to layers of API-led connectivity."},{title:"Assign APIs to layers according to ownership, functional ...",desc:"Assign APIs to layers according to ownership, functional focus, and rate of change."},{title:"Recommend the most appropriate approach relating the API ...",desc:"Recommend the most appropriate approach relating the API data model of System APIs to that of their backend system based on specific requirements and organizational characteristics."},{title:"Recommend the use of an Enterprise Data Model or Bounded ...",desc:"Recommend the use of an Enterprise Data Model or Bounded Context Data Models based on a set of APIs and specific preferences and organizational characteristics."},{title:"Select DataGraph only for suitable roles in an applicatio...",desc:"Select DataGraph only for suitable roles in an application network, according to its high-level features."}]},
      {name:"Governing web APIs on Anypoint Platform",pct:17,color:"#9B59B6",desc:"Make appropriate use of API instances and environments in API Manager, taking into account the nature of the API and ...",keyTopics:[{title:"Make appropriate use of API instances",desc:"Make appropriate use of API instances and environments in API Manager, taking into account the nature of the API and the underlying data and system."},{title:"Select appropriate API policies",desc:"Select appropriate API policies and other components of the API to support specific non-functional requirements (NFRs)."},{title:"Identify any change(s) required to an API specification t...",desc:"Identify any change(s) required to an API specification to reflect the application of an API policy with specific characteristics."},{title:"Select an approach to API policy enforcement based on spe...",desc:"Select an approach to API policy enforcement based on specific preferences and constraints, including, but not limited to, API proxies/API gateways and Anypoint Service Mesh."},{title:"Secure web APIs using API policies appropriately chosen f...",desc:"Secure web APIs using API policies appropriately chosen for the API's tier (System, Process, Experience)."},{title:"Describe in what circumstances",desc:"Describe in what circumstances and how to pass client ID and secret to a web API."},{title:"request access to an API version for an API client,",desc:"Explain how to request access to an API version for an API client, and how that access is approved and revoked."},{title:"Select appropriate API policies to enforce non-functional...",desc:"Select appropriate API policies to enforce non-functional security constraints on web API invocations."},{title:"relationships of Anypoint Platform, external Identity Pro...",desc:"Explain the relationships of Anypoint Platform, external Identity Providers (IdPs), AP Business Groups, and API clients in the context of OAuth 2.0."},{title:"Identify scenarios needing custom API policies",desc:"Identify scenarios needing custom API policies."}]},
      {name:"Architecting and deploying API implementations",pct:11,color:"#1ABC9C",desc:"Understand how to use auto-discovery to link a web API implementation to an API instance managed with API Manager.",keyTopics:[{title:"use auto-discovery to link a web API implementation to an...",desc:"Explain how to use auto-discovery to link a web API implementation to an API instance managed with API Manager."},{title:"Identify requirements that call for the use of an Anypoin...",desc:"Identify requirements that call for the use of an Anypoint Virtual Private Cloud (VPC)."},{title:"Compare",desc:"Compare and contrast options for hosting and managing Anypoint Platform runtime planes."},{title:"Compare unit",desc:"Compare unit and integration tests and specify where MUnit is best employed."},{title:"Explain options for automated building, testing,",desc:"Explain options for automated building, testing, and deployment of API implementations and related artifacts in a DevOps setting."}]},
      {name:"Deploying API implementations to CloudHub",pct:11,color:"#E67E22",desc:"Understand the scenarios for which Object Store (OS) should be used with CloudHub.",keyTopics:[{title:"scenarios for which Object Store",desc:"Describe the scenarios for which Object Store (OS) should be used with CloudHub."},{title:"Select CloudHub worker sizes",desc:"Select CloudHub worker sizes and configuration as appropriate."},{title:"Given an app deployed to the CloudHub shared worker cloud...",desc:"Given an app deployed to the CloudHub shared worker cloud in one or more regions, describe and predict its reliability and performance characteristics."},{title:"defining differences between the CloudHub Shared",desc:"Identify the defining differences between the CloudHub Shared and Dedicated Load Balancers."},{title:"Compare",desc:"Compare and contrast the options for CloudHub networking in the presence of customer-owned Amazon VPCs and on-premises data centers."},{title:"Identify",desc:"Identify and avoid single points of failure in CloudHub deployments of API implementations."}]},
      {name:"Meeting API quality goals",pct:10,color:"#3498DB",desc:"Design, describe, and differentiate between scenarios that use an OS or caching.",keyTopics:[{title:"Design, describe,",desc:"Design, describe, and differentiate between scenarios that use an OS or caching."},{title:"Select resilience strategies that help web API clients gu...",desc:"Select resilience strategies that help web API clients guard against failures when invoking APIs."},{title:"Describe when horizontal scaling of an API implementation...",desc:"Describe when horizontal scaling of an API implementation is or is not likely to benefit response time and throughput as seen by API clients."}]},
      {name:"Monitoring and analyzing application networks",pct:12,color:"#E91E63",desc:"Identify the components of Anypoint Platform that generate data for monitoring and alerting.",keyTopics:[{title:"components of Anypoint Platform that generate data for mo...",desc:"Identify the components of Anypoint Platform that generate data for monitoring and alerting."},{title:"metrics collected by Anypoint Platform for API invocations",desc:"Describe the metrics collected by Anypoint Platform for API invocations."},{title:"Specify alerts to define for key metrics of API invocatio...",desc:"Specify alerts to define for key metrics of API invocations for all layers of API-led connectivity."},{title:"Specify alerts to define for Mule applications",desc:"Specify alerts to define for Mule applications."}]},
    ],
    studyDays:[
  ...
  "MuleSoft Platform Integration Architect": {
    ...
    overview: "The MuleSoft Certified Platform Architect - Level 2 (Integration Architect) certification validates advanced MuleSoft architecture skills. Candidates demonstrate mastery of complex enterprise integration design, multi-cloud architecture, advanced governance, and technical leadership in large-scale integration programs.",
        domains:[
      {name:"Initiating integration solutions on the Anypoint Platform",pct:8,color:"#00A1E0",desc:"Differentiate between functional and non-functional requirements for integration solutions.",keyTopics:[{title:"Differentiate between functional",desc:"Differentiate between functional and non-functional requirements for integration solutions."},{title:"Select features of Anypoint Platform for designing",desc:"Select features of Anypoint Platform for designing and managing web and event-driven application programming interfaces (APIs)."},{title:"Select deployment options of the Anypoint Platform contro...",desc:"Select deployment options of the Anypoint Platform control plane and runtime plane."}]},
      {name:"Designing for the runtime plane technology architecture",pct:15,color:"#2ECC71",desc:"Analyze the mode of operation of a Mule runtime cluster that differentiates it from other deployment options.",keyTopics:[{title:"Analyze the mode of operation of a Mule runtime cluster t...",desc:"Analyze the mode of operation of a Mule runtime cluster that differentiates it from other deployment options."},{title:"Design integration solutions deployed to CloudHub to addr...",desc:"Design integration solutions deployed to CloudHub to address specific requirements using CloudHub's network features."},{title:"Choose Mule runtime domains",desc:"Choose Mule runtime domains and domain-shared configuration only for those requirements that clearly benefit from their capabilities."},{title:"Design Mule applications making effective use of the impl...",desc:"Design Mule applications making effective use of the implications of the Mule 4 class loader isolation of Mule modules."},{title:"characteristics",desc:"Describe the characteristics and implications of the Mule 4 reactive event processing model."}]},
      {name:"Designing architecture using integration paradigms",pct:10,color:"#F39C12",desc:"Create high-level integration architectures using API-led Connectivity.",keyTopics:[{title:"Create high-level integration architectures using API-led...",desc:"Create high-level integration architectures using API-led Connectivity."},{title:"Create high-level integration architectures using web APIs",desc:"Create high-level integration architectures using web APIs and HTTP."},{title:"Create high-level integration architectures using event-d...",desc:"Create high-level integration architectures using event-driven APIs and message brokers."},{title:"Design Mule applications",desc:"Design Mule applications and integration solutions using common messaging patterns and technologies."}]},
      {name:"Designing and developing Mule applications",pct:15,color:"#E74C3C",desc:"Select among available options for setting Mule application properties.",keyTopics:[{title:"Select among available options for setting Mule applicati...",desc:"Select among available options for setting Mule application properties."},{title:"Select",desc:"Select and use fundamental features available to all Mule applications."},{title:"Design Mule applications using core routers available to ...",desc:"Design Mule applications using core routers available to all Mule applications."},{title:"fundamental features of the Salesforce Connector",desc:"Describe the fundamental features of the Salesforce Connector."},{title:"Design Mule applications using common features of core co...",desc:"Design Mule applications using common features of core connectors."},{title:"Select",desc:"Select and use the available sources of metadata in the Transform Message component."},{title:"Design Mule applications",desc:"Design Mule applications and integration solutions using a Common/Canonical Data Model."},{title:"Correctly apply methods for validating data in Mule appli...",desc:"Correctly apply methods for validating data in Mule applications."}]},
      {name:"Designing automated tests for Mule applications",pct:5,color:"#9B59B6",desc:"Design unit test suites using MUnit and Studio's related features.",keyTopics:[{title:"Design unit test suites using MUnit",desc:"Design unit test suites using MUnit and Studio's related features."},{title:"Identify test requirements",desc:"Identify test requirements and scenarios that are best addressed using integration testing or performance testing."}]},
      {name:"Designing integration solutions to meet persistence requirements",pct:10,color:"#1ABC9C",desc:"Design Mule applications using Virtual Machine (VM) queues and the Anypoint VM Connector in all deployment options.",keyTopics:[{title:"Design Mule applications using Virtual Machine",desc:"Design Mule applications using Virtual Machine (VM) queues and the Anypoint VM Connector in all deployment options."},{title:"Design Mule applications using Object Stores",desc:"Design Mule applications using Object Stores (OSs), the OS Connector, and OS services in all deployment options."},{title:"Design Mule applications",desc:"Design Mule applications and integration solutions using stateful components that may be configured with an OS."}]},
      {name:"Designing integration solutions to meet reliability requirements",pct:8,color:"#E67E22",desc:"Select alternatives to traditional transactions (local or XA) where appropriate and beneficial.",keyTopics:[{title:"Select alternatives to traditional transactions",desc:"Select alternatives to traditional transactions (local or XA) where appropriate and beneficial."},{title:"Recognize the purpose",desc:"Recognize the purpose and characteristics of Until Successful scope, reconnection strategies, and redelivery policies."},{title:"Differentiate between disaster recovery",desc:"Differentiate between disaster recovery and high availability and the basic approaches to achieving either in all deployment options."},{title:"Design Mule applications",desc:"Design Mule applications and integration solutions using local and XA transactions for all Mule connectors that support them."}]},
      {name:"Designing integration solutions to meet performance requirements",pct:7,color:"#3498DB",desc:"Design Mule applications and integration solutions to meet performance and capacity goals.",keyTopics:[{title:"Design Mule applications",desc:"Design Mule applications and integration solutions to meet performance and capacity goals."},{title:"Design Mule applications using available streaming featur...",desc:"Design Mule applications using available streaming features in Mule."},{title:"Design Mule applications to process large sequences/strea...",desc:"Design Mule applications to process large sequences/streams of messages."}]},
      {name:"Designing integration solutions to meet security requirements",pct:8,color:"#E91E63",desc:"Design secure access to the Anypoint Platform control plane and APIs.",keyTopics:[{title:"Design secure access to the Anypoint Platform control plane",desc:"Design secure access to the Anypoint Platform control plane and APIs."},{title:"Design secure edge access using Anypoint Security",desc:"Design secure edge access using Anypoint Security."},{title:"Analyze",desc:"Analyze and counteract potential security vulnerabilities of Mule applications."},{title:"Recognize the audit logging capabilities of Anypoint Plat...",desc:"Recognize the audit logging capabilities of Anypoint Platform."}]},
      {name:"Applying DevOps practices and operating integration solutions",pct:14,color:"#607D8B",desc:"Create the high-level design of continuous integration (CI) and continuous delivery (CD) pipelines for Mule applicati...",keyTopics:[{title:"Create the high-level design of continuous integration",desc:"Create the high-level design of continuous integration (CI) and continuous delivery (CD) pipelines for Mule applications using MuleSoft-provided Maven plugins."},{title:"features",desc:"Identify the features and characteristics for automating interactions with Anypoint Platform."},{title:"Design the logging configurations",desc:"Design the logging configurations and options of Mule applications in all deployment options."},{title:"features",desc:"Identify the features and characteristics of Anypoint Monitoring in all deployment options."}]},
    ],
    studyDays:[
